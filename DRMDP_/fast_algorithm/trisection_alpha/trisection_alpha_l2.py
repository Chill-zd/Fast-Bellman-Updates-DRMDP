...
def cal_alpha_cum_l2(p_sa_bar, b_sa, N, alpha, gamma):
    ...
    for i in range(N):
        ...
        # print('ou',solve_sub_l2(temp_p_sa_bar, b_sa, alpha))
        # print('gu',solve_sub_l2_gu(temp_p_sa_bar, b_sa, alpha))
...
def solve_alpha_trisec_l2(gamma, p_sa_bar, N, b_sa, min_ba):
    ...
    while abs(ub - lb) > eps:
        ...
        # reuse existing arrays and calculate function values
        ...
        # Use conditional expression to find index corresponding to lowest function value
        index_min = function_values[1] < function_values[0] and 1 or 0

        # Use conditional expression to update lb and ub
