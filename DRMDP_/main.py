...
def __main__():
    ...
    # ------------------------------------    epoch curve ---------------------------------------- #
    # '''test julien speed for different epochs l1'''
    # print('test julien speed for different epochs l1 \n')
    # compare_julian_epochs_l1(sample_transitions, states, actions, rewards, Lambd, theta, N)
    # compare_julian_epochs_l2(sample_transitions, states, actions, rewards, Lambd, theta, N)
